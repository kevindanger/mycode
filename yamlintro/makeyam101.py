...
# yaml is NOT part of the standard libary
...
def main():
    ...
    hitchhikers = [{"name": "Zaphod Beelebrox", "species": "Betelgeusian"}, \
            {"name": "Aruthur Dent", "species": "Human"}]
    ...
    ## the json lib uses .dump() to creat a string and .dumps() to write to files 
