#!/usr/bin/env python3
## USOpen Tournament Switch Checker -- 2019.05.08
''' usopen.py
...
## pyexcel and pyexce-xls are requried for our program to execute
# python3 -m pip install --user pyexcel
# python3 -m pip install --user pyexcel-xls
import pyexcel

# python3 -m ip install --user netmiko
...
def retv_excel(par):
    ...
    for record in records:
        # adds a new IP and driver key:value pai to our dictionary
...
##Main function - This is code that runs our functions
def main():
